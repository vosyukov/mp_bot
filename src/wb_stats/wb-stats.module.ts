...
@Module({
  imports: [TypeOrmModule.forFeature([SalesReportRepository, OrderReportRepository]), UtilsModule, UserModule, WbApiModule, ShopModule, UserSettingsModule, BullModule.registerQueue({
    name: 'wb_parser',
  })],
